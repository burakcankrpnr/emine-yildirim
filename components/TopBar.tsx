export default function TopBar() {
  return (
    <div className="sticky top-0 z-40 border-t border-gray-600 border-b border-gray-300" style={{ backgroundColor: '#f3ebe6' }}>
        ...
        <div className="flex justify-between items-center py-2 text-sm">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              >
                emineyildirimpsikolog@gmail.com 
              </a>
            </div>
          </div>
          <div className="lg:hidden flex items-center">
            <a 
              href="mailto:emineyildirimpsikolog@gmail.com " 
              className="text-gray-600 underline hover:text-gray-800 text-xs"
            >
              emineyildirimpsikolog@gmail.com 
            </a>
          </div>
          ...
          <div className="hidden md:flex items-center space-x-3">
            <a 
              ...
              className="w-8 h-8 rounded-full bg-white border border-amber-200 flex items-center justify-center hover:bg-amber-50 transition"
            >
